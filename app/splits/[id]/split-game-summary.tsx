...
function getWinStatus(win: boolean | null) {
  if (win == true) {
    return <Text fontSize="xl" color="green.500">Won</Text>
  }

  if (win == false) {
    return <Text fontSize="xl" color="red.500">Lost</Text>
  }

  return <Text fontSize="xl" color="gray.500">-</Text>;
}
